...
window.DASH = {
  ...
  // Small cities are shown in increasing local time; ties keep this order.
  cities: [
  ...
  // Weather alert cards: element "alert-<id>". National Weather Service, US only.
  // The card stays invisible while there's no alert. Add &alertTest=1 after the key in
  // the URL to show a sample alert.
  weatherAlerts: [
    { id: 'longbeach', name: 'Long Beach', lat: 33.7701, lon: -118.1937 },
    { id: 'denver', name: 'Denver', lat: 39.7392, lon: -104.9903 },
  ],
  alertRefreshMinutes: 5,
